...
func main() {
	...
	// Data Manager
	r.Get("/api/data/export",        h.ExportTable)
	r.Get("/api/data/export-all",    h.ExportAll)
	r.Get("/api/data/schema",        h.TableSchema)
	r.Post("/api/data/import/preview", h.ImportPreview)
	r.Post("/api/data/import/commit",  h.ImportCommit)
